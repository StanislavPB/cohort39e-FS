package facultative.lesson_03.code.part_01.p4_exchanger.example2;
...
//    private static final
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] p2 = new String[]{"{посылка B->C}", null};
...
class Truck implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            System.out.println("Груз в грузовике " + Arrays.toString(parcels));
